...
import { ArrowLeft, Search, CheckCircle, UserCheck, Loader2, X } from "lucide-react";


// Simple debounce hook if package not available
...
export default function CheckInKioskPage() {
    ...
    const handleCheckIn = async (member: any) => {
        // Optimistic UI could be used here, but for now just async
        ...
        if (res.success) {
            ...
            setResults([]);
            searchInputRef.current?.focus(); // Keep focus for next person
        ...
        <div className="min-h-screen bg-muted flex flex-col items-center pt-10 px-4">
            ...
            <div className="w-full max-w-2xl flex items-center justify-between mb-8">
                ...
                <div className="text-center">
                    ...
                    <p className="text-sm text-muted-foreground">Search by name or phone</p>
                </div>
